...
## إصلاح مهم بعد الترقية إلى v7.1
إذا كانت قاعدة Supabase عندك من نسخة أقدم وشهدت خطأ wamid/uuid، نفّذ الملف `database/migrate_messages_log_id_to_text.sql` مرة واحدة فقط.
